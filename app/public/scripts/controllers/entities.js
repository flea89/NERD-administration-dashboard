...
angular.module('publicApp')
    .controller('EntitiesCtrl', function($scope, entity, $q,mergeLine) {
    ...
    // }]);
    $scope.UsersGroupByNerdType = [];
    $scope.UsersGroupByNerdTypeYahoo = [];
    $scope.UsersGroupByNerdTypeWikimeta = [];
    $scope.UsersGroupByNerdTypeAlchemy = [];
